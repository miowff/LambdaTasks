...
class CurrenciesController
{
    ...
    async addNew(req:Request,res:Response,next:NextFunction)
    {
        try
        {
            ...
            res.status(200).json({Message:"Successfully added",Currency:req.body})
        }
        catch(err)
        {
           next(err) 
    ...
    async deleteCurrency(req:Request,res:Response,next:NextFunction)
    {
        try
        {
            ...
            res.status(200).json({Message:"Successfully deleted",Currency:req.body})
        }
        catch(err)
        {
           next(err) 
    ...
    async updateCurrency(req:Request,res:Response,next:NextFunction)
    {
        try
        {
            ...
            res.status(200).json({Message:"Successfully updated",Currency:req.body})
        }
        catch(err)
        {
           next(err) 
