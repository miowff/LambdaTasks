...
export default ()=>
{
    ...
    const data = JSON.stringify(markets[Math.floor(Math.random()*markets.length)]);
    console.log(data);
    http.post('https://5u55q8r2zh.execute-api.us-east-1.amazonaws.com/dev/send-message-to-SQS',data,
    {
        headers:
        {
