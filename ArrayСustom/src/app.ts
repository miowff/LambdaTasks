...
const persons: Person[] = [
  new Person(1, "Person1", 100),
  new Person(2, "Person2", 500),
  new Person(3, "Person3", 300),
  new Person(4, "Person4", 300),
];
...
//FindLast
console.log(
  "Array.findLast(predicate) " + numbersArray.findLast((item) => item % 2 == 0)
);
//Chunked
