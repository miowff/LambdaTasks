...
import { CLIENT_ID,CLIENT_SECRET,REFRESH_TOKEN,FOLDER_ID } from "./tokens.js";
...
export async function upload(fileName,path)
{
    ...
    try
    {
       ...
       var result = await axios.post(uploadUrl,formData,
            {
                headers: 
                {
...
{
    var fileUrl = `https://www.googleapis.com/drive/v3/files/${fileId}/permissions`;
    try
    {
